...
private struct CpuSlot: View {
    ...
    var body: some View {
        SlotIcon(iconName: "CPU", value: cpuStore.usageString, worstCase: "100%", tint: healthStore.abnormalComponent == .CPU ? healthStore.level.accent : nil)
    }
}
...
private struct MemorySlot: View {
    ...
    var body: some View {
        SlotIcon(iconName: "Memory", value: memoryStore.usedPercentageString, worstCase: "100%", tint: healthStore.abnormalComponent == .Memory ? healthStore.level.accent : nil)
    }
}
...
private struct GpuSlot: View {
    ...
    var body: some View {
        SlotIcon(iconName: "GPU", value: gpuStore.usageAverageString ?? "N/A", worstCase: "100%")
    }
}
...
private struct DiskSlot: View {
    ...
    var body: some View {
        SlotIcon(iconName: "Disk", value: diskStore.freeString, worstCase: "888.8 GB", tint: healthStore.abnormalComponent == .Disk ? healthStore.level.accent : nil)
    }
}
...
private struct BatterySlot: View {
    ...
    var body: some View {
        SlotIcon(iconName: "Battery", value: batteryStore.charge.percentageString, worstCase: "100%", tint: tint)
    }
}
...
private struct FanSlot: View {
    ...
    var body: some View {
        SlotIcon(iconName: "Fan", value: fanAverageString, worstCase: "8888")
    }
}
...
/// Icon-based slot view that displays a small icon instead of text label
